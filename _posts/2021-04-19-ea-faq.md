...
category: devlog
thumb: /assets/posts/ea-faq/thumb.png
---
...
Check the [Troubleshooting](https://github.com/voxeltycoon/bug-tracker/blob/master/README.md) page.
...
Signals are battle-tested for a couple of years already, so we are pretty confident there are no major bugs. The Voxel Tycoon using implementation called block signals, which may the source of confusion for players who are more familiar with other implementations.
...
No timeframe at this point, this is a pretty major task that is at its early stages currently. We'd say don't expect it arrives this year. If you're looking exclusively for multiplayer experience, we advise you to hold your purchase until it will implemented.
